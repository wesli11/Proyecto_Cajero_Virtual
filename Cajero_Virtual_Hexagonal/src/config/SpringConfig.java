...
public class SpringConfig {
	@Value("${gestion.banca.driver}")
	String driver;
	@Value("${gestion.banca.url}")
	String cadena;
	@Value("${gestion.banca.user}")
	String usuario;
	@Value("${gestion.banca.pwd}")
	String pwd;
	//@Bean
	...
	private DataSource crearDatasource() {
        ...
        try {
            dataSource = jndi.lookup("java:comp/env/refbanca", DataSource.class);
